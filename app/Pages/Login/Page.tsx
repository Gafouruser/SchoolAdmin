      ...
      <div className='mt-16 mb-16 drop-shadow-md flex justify-center items-center'>
        ...
        <div  className='bg-white w-96 h-[30rem] rounded-r-3xl flex flex-col gap-10 justify-center items-center'>
            ...
            <input
              ...
              className="bg-[#EAEEF3] px-5 py-2 border rounded-lg w-full focus:outline-none focus:ring-2 focus:ring-[#073861] focus:ring-opacity-50 placeholder:text-black font-thin"
              required
            />
          ...
          <div className="relative">
            ...
            <button type='submit' className='bg-[#FFAB00] text-white text-sm px-12 py-2 font-bold rounded-xl hover:bg-[#073861] transition'>Connecter</button>
        </div>
      </div>
      <Footer />
    </div>
